...
export TOKEN_PRIMARY="$THEME_PURPLE" # Primary accent (active/focused)
export TOKEN_SECONDARY="$THEME_RED"  # Secondary accent (inactive, cursor)
export TOKEN_TEXT="$THEME_FG"
export TOKEN_TEXT_DIM="$THEME_FG_DIM"
export TOKEN_BORDER="$THEME_PURPLE"        # Border color
