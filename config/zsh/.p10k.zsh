# Generated by Powerlevel10k configuration wizard on 2025-12-01 at 02:44 EST.
...
# Load unified theme colors (auto-generated by colors.sh)
# The theme file is automatically sourced below to provide P10K_* color variables
# You can use these variables in POWERLEVEL9K_* settings, e.g.:
# typeset -g POWERLEVEL9K_DIR_BACKGROUND=$P10K_PRIMARY
...
() {
  ...
  # Load unified theme colors if available (auto-generated by colors.sh)
  # Try both possible locations (symlinked config or direct path)
  local theme_file="${HOME}/.config/zsh/theme/colors"
  [[ -f "$theme_file" ]] && source "$theme_file" || {
    # Fallback: try relative to this file
    local p10k_dir="$(dirname "${(%):-%x}")"
    [[ -f "$p10k_dir/theme/colors" ]] && source "$p10k_dir/theme/colors"
  }
